		...
		<tbody>
			...
			<tr>
				...
				<div id="button" class="mt10">
					...
					<a href="<?php echo site_url().'/jobs/jobs/addJobs'; ?>">
						...
						<div class="box span10 oh">
							<table width="100%" border="0" cellpadding="0" cellspacing="0"
								...
								<tr class="tr">
									...
									<td class="td_center"><?php echo $v['position']?>
									</td>
									<td class="td_center"><?php echo $v['type']?></td>
									<td class="td_center"><?php echo $v['salary']?></td>
									<td class="td_center"><?php echo $v['age']?></td>								
									<td class="td_center"><?php echo $v['education']?></td>
									<td class="td_center"><?php echo $v['rank']?></td>
									<td class="td_center"><?php echo date('Y-m-d', $v['ctime'])?></td>
									<td class="td_center">
									【<a class="link-update" href="<?php echo site_url().'/jobs/jobs/editJobs/'.$v['id'] ?>">修改</a>】
									&nbsp;&nbsp;&nbsp;&nbsp;
										【<a class="link-del" href="<?php echo site_url().'/jobs/jobs/delJobs/'.$v['id'] ?>">删除</a>】
									</td>
								</tr>
								<?php endforeach; ?>
