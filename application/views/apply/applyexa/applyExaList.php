				...
				<td valign="top" bgcolor="#F7F8F9">
					<div id="button" class="mt10">
						...
						<input type="button" name="button" class="btn btn82 btn_search fs"
							value="查询"> <a
							href="<?php echo site_url().'/apply/applyExa/addExa'; ?>"> <input
					...
					<div id="table" class="mt10">
						<div class="box span10 oh">
							<table width="100%" border="0" cellpadding="0" cellspacing="0"
								...
								<?php foreach ($appexa as $v): ?>
								<tr class="tr">
									<td class="td_center"><input type="checkbox"></td>
									<td class="td_center"><a
										href="<?php echo site_url().'/apply/applyExa/editExa/'.$v['id'] ?>"><?php echo $v['title']?></a></td>
									...
									<td class="td_center"><a class="link-update"
										href="<?php echo site_url().'/apply/applyExa/editExa/'.$v['id'] ?>">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;
