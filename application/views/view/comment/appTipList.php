						...
						<div class="box span10 oh">
							<table width="100%" border="0" cellpadding="0" cellspacing="0"
								...
								<tr class="tr">
									...
									<td class="td_center"><a href="<?php echo site_url().'/apply/appTip/editTip/'.$v['id'] ?>"><?php echo $v['title']?></a></td>
									...
									&nbsp;&nbsp;&nbsp;&nbsp;
										【<a class="link-del" href="<?php echo site_url().'/apply/appTip/delTip/'.$v['id'] ?>">删除</a>】
									</td>
								</tr>
								<?php endforeach; ?>
